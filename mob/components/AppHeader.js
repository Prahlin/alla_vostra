...
const noCheeseboardHeroImage = require("../background1_no_cheeseboard.webp");
const defaultHeroImage = require("../background1.webp");
const cheeseboardProductsImage = require("../cheeseboard_products.webp");
